...
const ActivityDetailsPage = () => {
   ...
   const handleAddToCart = async (event) => {
      ...
      if (
         ...
         openSnackbar(
            "There are errors in adding this booking to cart",
            "error"
         );
         return;
      }
                  ...
                  <Box
                     ...
                     <Box>
                        ...
                        {currentActivity?.linkedVendor && (
                           <VendorProfileItem
                              vendor={currentActivity?.linkedVendor}
                           />
                        )}
                     </Box>
                  ...
                  <Box
                     ...
                     <Swiper
                        ...
                        {currentActivity?.preSignedImages &&
                           currentActivity?.preSignedImages.map(
                              (image, index) => (
                        ...
                        <Box
                           ...
                           <Box display="flex" flexDirection="row">
                              ...
                              <Typography
                                 ...
                                 variant="h5"
                                 fontWeight="700">
                                 {currentActivity?.minimumPricePerPax?.toFixed(
                                    2
                                 )}
                              </Typography>
                           </Box>
                        ...
                        {selectedDate &&
                           ...
                           ((currentActivity.weekendPricing.amount !== null &&
                              ...
                              <Box mt={1}>
                                 ...
                                 {(dayjs(selectedDate).day() == 0 ||
                                    dayjs(selectedDate).day() == 6) &&
                                    currentActivity.weekendPricing.amount !==
                                       null && (
                                       <Box
                                          display="flex"
                                          flexDirection="row"
                  ...
                  <Box mb={2}>
                     ...
                     <Grid container spacing={2} p={2}>
                        ...
                        <Grid item display="flex" flexDirection="row">
                           ...
                           {currentActivity?.dayAvailabilities.map(
                              (location, index) => (
                                 <Typography
                                    color="secondary"
                                    key={index}
                  ...
                  <Box width="100%" p={2}>
                                 ...
                                 <Box
                                    ...
                                    <Box
                                       ...
                                       <Typography
                                          ...
                                          variant="h4"
                                          fontWeight="700">
                                          {activityPricingRule.clientPrice.toFixed(
                                             2
                                          )}
                                       </Typography>
                                       <Typography
                     ...
                     <Box
                        ...
                        <Typography sx={{ marginLeft: "5px" }}>
                           Book <b>{currentActivity?.bookingNotice}</b> days in
                           advance
                        </Typography>
                     </Box>
                     <Box
