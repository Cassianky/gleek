      ...
      <div style={{ width: "100%" }}>
        ...
        <Grid sx={{ width: "50%", margin: "auto" }}>
          ...
          >
            ...
            <Select value={filter} label="Theme" onChange={handleThemeChange}>
              <MenuItem key="select" value="">
                Select a Parent Theme
              </MenuItem>
              {themes?.length > 0 ? (
                themes?.map((theme) => (
                  <MenuItem key={theme.parent.name} value={theme.parent.name}>
                    {theme.parent.name}
                  </MenuItem>
                ))
              ) : (
        ...
        <TableContainer sx={{ width: "100%" }}>
          {isClientRanked ? (
            ...
            >
              ...
              {filteredRows.find((row) => row._id == client?._id).rank > 1 ? (
            ...
            <Alert severity="info" sx={{ width: "50%", margin: "1% auto" }}>
          ...
          {filteredRows.length > 0 ? (
            ...
            <Alert severity="info" sx={{ width: "50%", margin: "1% auto" }}>
              No bookings have been under this theme
            </Alert>
          )}
        </TableContainer>
      </div>
