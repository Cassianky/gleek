...
function FillSurvey() {
  ...
  const handleSubmit = () => {
    try {
      submitSurveyForBooking(bookingId, surveyData, reviewData);
  ...
  >
    ...
    >
      ...
      <Typography variant="body2">
        Thank you for choosing one of our activities! Your response will help us
        improve to meet your needs better.
      </Typography>
      ...
      <form>
        <Grid container spacing={2} p={7}>
          ...
          <Grid item xs={12}>
            <StyledPaper>
              ...
              <TextField
                ...
                onChange={(e) =>
                  handleFieldChange("potentialNextActivityDate", e.target.value)
                }
              />
            </StyledPaper>
          </Grid>
          ...
          <Grid item xs={12}>
            <StyledPaper>
              ...
              <Typography paddingY={1} variant="body1">
                ...
                run by a different facilitator with a difference in the
                programme
              </Typography>
          ...
          <Grid item xs={12}>
            <StyledPaper>
              <Typography paddingY={1} variant="h6">
                If you were satisfied with your experience, we would appreciate
                a short testimonial that we can share on our platforms.
              </Typography>
              <TextField
                label="Testimonial"
                variant="standard"
          ...
          <Grid item xs={12}>
            <Button
              ...
              size="large"
              disabled={surveyData.status === "SUBMITTED"}
              fullWidth
            >
              Submit
            </Button>
